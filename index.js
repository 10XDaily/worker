...
`// TODO - dynamic plaintext version of the HTML email? (strip HTML)
  ...
  //     ], // No attachements needed. 400kb max combined size if needed in the future.
      "sendSettings": {
        ...
        "excludedCampaigns": [],
        "excludedSegments": [],
        "selectedContacts": ["VKVmI6q", "VK7KbWJ"], // ["VWqT16E"], // ["V5p8EtA"], // ["VohAb0F"], // Contact ID for email subscriber "test+5@10x.day" // {campaignId} = Q1Oz0 // curl -H "X-Auth-Token: api-key ____________" https://api.getresponse.com/v3/campaigns/Q1Oz0/contacts
